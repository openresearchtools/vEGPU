...
public struct MachineConfig: Codable, Equatable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.guiRetina = try container.decodeIfPresent(Bool.self, forKey: .guiRetina) ?? true

...
struct PEGPUCLI {
    ...
    private static func printUsage() {
        print("pegpu machine <status|paths|config|save-config|manifest|init|start|stop|reset|doctor|driver-status|reinstall-driver|install-nvidia|linux-password|audio-status|audio-start|audio-stop|llms-runtime>")
    }
